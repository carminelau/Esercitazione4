...
public class Str_ConcatOperation extends BinaryOperation {
    /**
     ...
     */
    public Str_ConcatOperation(int leftPosition, int rightPosition, Expr leftOperand, Expr rightOperand) {
